...
1. [Change validation rules](/docs/macros/samples/pdf-editor/change-validation-rules.md) — set rules programmatically.
2. [Limit number of characters](/docs/macros/samples/pdf-editor/limit-number-of-characters.md) — enforce input length.
3. [Set checkbox tip text](/docs/macros/samples/pdf-editor/set-checkbox-tip-text.md) — add guidance to form fields.
