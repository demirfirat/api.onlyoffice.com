...
You can also download this plugin from the [ONLYOFFICE App Directory](https://www.onlyoffice.com/app-directory/en/html) and install it following the [desktop](/docs/plugins/tutorials/installing/onlyoffice-desktop-editors.md) or [cloud](/docs/plugins/tutorials/installing/onlyoffice-cloud.md) installation instructions.
