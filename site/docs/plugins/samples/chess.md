...
Download this plugin from [GitHub](https://github.com/ONLYOFFICE/onlyoffice.github.io/tree/master/sdkjs-plugins/content/chess) and install it following the [desktop](/docs/plugins/tutorials/installing/onlyoffice-desktop-editors.md), [on-premises](/docs/plugins/tutorials/installing/onlyoffice-docs-on-premises.md), or [cloud](/docs/plugins/tutorials/installing/onlyoffice-cloud.md) installation instructions.
