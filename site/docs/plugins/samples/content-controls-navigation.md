...
Download this plugin from [GitHub](https://github.com/ONLYOFFICE/sdkjs-plugins/tree/master/example_work_with_content_controls_navigation) and install it following the [desktop](/docs/plugins/tutorials/installing/onlyoffice-desktop-editors.md), [on-premises](/docs/plugins/tutorials/installing/onlyoffice-docs-on-premises.md), or [cloud](/docs/plugins/tutorials/installing/onlyoffice-cloud.md) installation instructions.
...
- [button](/docs/plugins/customization/buttons.md)
...
- executeMethod ("[GetCurrentContentControl](/docs/office-api/usage-api/document-api/ApiDocument/Methods/GetCurrentContentControl.md)")
- executeMethod ("[MoveCursorToContentControl](/docs/plugins/interacting-with-editors/document-api/Methods/MoveCursorToContentControl.md)")
