...
5. Change the cursor position. The *event: [onTargetPositionChanged](/docs/plugins/interacting-with-editors/form-api/Events/onTargetPositionChanged.md)* message will appear in the console.
