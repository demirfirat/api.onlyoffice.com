...
1. Use the [Invoices plugin](../../samples/plugin-samples/invoices.md) to pull order data and fill a template.
...
1. Use the [Templates plugin](../../samples/plugin-samples/templates.md) to select and populate document templates.
