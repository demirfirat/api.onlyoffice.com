...
More information about the plugin structure can be found [here](../../../plugins/structure/configuration/configuration.md).
...
All the config parameters are described in the [documentation](../../../plugins/structure/configuration/configuration.md).
...
Detailed instructions can be found [here](../../../plugins/tutorials/installing/onlyoffice-desktop-editors.md).
