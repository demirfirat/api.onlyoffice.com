...
| *icons*    | string                                | The item icons (see the plugins [config](../../../plugins/structure/configuration/configuration.md#variationsicons) documentation). |
...
| *icons*          | string \| object                            | The item icons (see the plugins [config](../../../plugins/structure/configuration/configuration.md#variationsicons) documentation). |
