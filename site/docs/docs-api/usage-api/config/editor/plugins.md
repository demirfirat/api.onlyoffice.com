...
Defines the array of plugin identifiers from the [config.json](../../../../plugins/structure/configuration/configuration.md#guid) file. The plugins will automatically start when the editor opens and run one-by-one in the specified order.
...
Defines the array of absolute URLs to the plugin [config.json](../../../../plugins/structure/configuration/configuration.md) files.
